package br.com.nandolrs.carrorobosuperremoto.lib;;
...
public class Rede extends android.os.AsyncTask <String, Void, String>
{
    ...
    String _url;
    String _recebido;
    br.com.nandolrs.carrorobosuperremoto.lib.Cabecalho[] _headers;
    String _mensagem;
    ...
    public void setHeaders(br.com.nandolrs.carrorobosuperremoto.lib.Cabecalho[] valor)
    {
        _headers = valor;
    }

    public br.com.nandolrs.carrorobosuperremoto.lib.Cabecalho[] getHeaders()
    {
        return _headers;
    }
